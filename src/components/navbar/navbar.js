...
const NavBar = ({ updateCurse, updateLeave }) => {
    ...
    return (
        <div className={nav ? ("navbar-container2") : ("navbar-container")}>
            <div className={nav ? ("brand-name") : ("hide-brand-name")}>get<span id="colored">linked</span></div>
            <div className={nav ? ("hide-brand-name") : ("brand-name")}>get<span id="colored">linked</span></div>
            <div className="nav-items">
                <ul className='desktop-nav' >
                    <li
                        onMouseOver={updateCurse}
                        onMouseLeave={updateLeave}
                        onClick={updateLeave}
                    >
                        <Link className="exclude-from-animation">Timeline</Link>
                    </li>
                    <li
                        onMouseOver={updateCurse}
                        onMouseLeave={updateLeave}
                        onClick={updateLeave}
                    >
                        <Link className="exclude-from-animation">Overview</Link>
                    </li>
                    <li
                        onMouseOver={updateCurse}
                        onMouseLeave={updateLeave}
                        onClick={updateLeave}
                    >
                        <Link className="exclude-from-animation">FAQs</Link>
                    </li>
                    <li id="contact-btn"
                        onMouseOver={updateCurse}
                        onMouseLeave={updateLeave}
                        onClick={updateLeave}>
                        <Link to='/contact' className="exclude-from-animation">Contact</Link>
                    </li>
                    <li id="register-btn"
                        onMouseOver={updateCurse}
                        onMouseLeave={updateLeave}
                        onClick={updateLeave}>
                        <Link to='/register' className="exclude-from-animation">Register</Link>
                    </li>
                </ul>
                {nav &&
            ...
            <div className={nav ? ("hide-svg-wrapper") : ("svg-wrapper")} onClick={() => { showNav(true) }}>
            ...
            <svg className={nav ? ("close-btn") : ("hide-close-btn")} xmlns="http://www.w3.org/2000/svg" width="11" height="11" viewBox="0 0 11 11" fill="none" onClick={() => { showNav(false) }}>
